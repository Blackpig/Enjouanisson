...
$route['articles'] = 'blog';
$route['articles/archive/([0-9]+)/([0-9]+)'] = 'blog/archive/$1/$2';
$route['articles/([0-9]+)/([0-9]+)/([a-zA-Z0-9_-]+)'] = 'blog/$1/$2/$3';

/* FireSale - Category Customisation */
$route['products'] = 'firesale/front_category/index';

/* FireSale - Category */
$route['products/([a-z0-9-_]+)(/:any)?'] = 'firesale/front_category/category/$1$2';
