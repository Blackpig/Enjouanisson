...
<?php if ($this->method == 'create'): ?>
	<h4><?php echo lang('recipes:create_title') ?></h4>
<?php else: ?>
	<h4><?php echo sprintf(lang('recipes:edit_title'), $post->title) ?></h4>
<?php endif ?>
</section>
...
<div class="tabs">
	...
	<ul class="tab-menu">
		<li><a href="#recipes-content-tab"><span><?php echo lang('recipes:content_label') ?></span></a></li>
		<?php if ($stream_fields): ?><li><a href="#recipes-custom-fields"><span><?php echo lang('global:custom_fields') ?></span></a></li><?php endif; ?>
		<li><a href="#recipes-options-tab"><span><?php echo lang('recipes:options_label') ?></span></a></li>
	</ul>

	<!-- Content tab -->
	<div class="form_inputs" id="recipes-content-tab">
		<fieldset>
			<ul>
				<li>
				...
				<li>
					<label for="status"><?php echo lang('recipes:status_label') ?></label>
					<div class="input"><?php echo form_dropdown('status', array('draft' => lang('recipes:draft_label'), 'live' => lang('recipes:live_label')), $post->status) ?></div>
				</li>
		
				<li class="editor">
					<label for="body"><?php echo lang('recipes:content_label') ?> <span>*</span></label><br>
	...
	<div class="form_inputs" id="recipes-custom-fields">
		<fieldset>
			<ul>
	...
	<!-- Options tab -->
	<div class="form_inputs" id="recipes-options-tab">
		<fieldset>
			<ul>
	
				<li>
					<label for="category_id"><?php echo lang('recipes:category_label') ?></label>
					<div class="input">
					<?php echo form_dropdown('category_id', array(lang('recipes:no_category_select_label')) + $categories, @$post->category_id) ?>
						[ <?php echo anchor('admin/recipes/categories/create', lang('recipes:new_category_label'), 'target="_blank"') ?> ]
					</div>
				</li>
				...
				<li class="date-meta">
					<label><?php echo lang('recipes:date_label') ?></label>
				...
				<?php else: ?>
					<li>
						<label for="comments_enabled"><?php echo lang('recipes:comments_enabled_label');?></label>
						<div class="input">
