...
<div class="tabs">
	...
	<ul class="tab-menu">
		...
		<?php if ($stream_fields): ?><li><a href="#event-custom-fields"><span><?php echo lang('global:custom_fields') ?></span></a></li><?php endif; ?>
	...
	<div class="form_inputs" id="event-content-tab">
		<fieldset>
			<ul>
				...
				<li class="editor">
					<label for="body"><?php echo lang('event:content_label') ?> <span>*</span></label><br>
	...
	<div class="form_inputs" id="event-custom-fields">
		<fieldset>
			<ul>
