...
class Admin_Categories extends Admin_Controller
{
	 ...
	 * - load the event_categories model.
	 * - load the categories and event language files.
	...
	public function index()
	{
		...
		$pagination = create_pagination('admin/event/categories/index', $total_rows, Settings::get('records_per_page'), 5);
	...
	public function create()
	{
		...
		{
			if ($id = $this->event_categories_m->insert($this->input->post()))
			{
	...
	public function edit($id = 0)
	{
		...
		if ($this->form_validation->run())
		{
			$this->event_categories_m->update($id, $this->input->post())
	...
	{
		if ($this->event_categories_m->check_title($title, $this->input->post('id')))
		{
	...
	{
		if ($this->event_categories_m->check_slug($slug, $this->input->post('id')))
		{
